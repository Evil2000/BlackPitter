...
public class IPv4 {
    ...
    public boolean isPrivate() {
        String[] privateIpRanges = {
                ...
                "192.168.0.0/16",
                "169.254.0.0/16"
                // 169.254.0.0/16 this is a "shared" IP range, but it is not routed on public nets
                // so we treat it as semi private
        };
        for (String privateIpRange : privateIpRanges) {
            IPv4 network = new IPv4(privateIpRange);
